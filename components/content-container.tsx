...
export function ContentContainer({ children }: { children: React.ReactNode }) {
  ...
  const fullBleed = pathname === "/" || pathname === "/vision" || pathname === "/notes" || pathname === "/player" || pathname === "/lockin" || pathname === "/chat" || pathname === "/news" || pathname === "/finance" || pathname === "/learn" || pathname === "/gym";
  return (
